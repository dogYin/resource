 ...
 * @date: 2020/7/6
 */
public class Asm4MethodAop {
    private static final String CLASS_PATH_DIR = "/E:/ucarinc_workspace/self/demo_exercise2/share-tech/asm-test1/src/main/java/com/yucx/exercise/calcu_method_cost_time";
     ...
     * 修改类中方法的字节码
     */
    private static void redefineTargetClass() {
        try {
            InputStream inputStream = new FileInputStream(CLASS_PATH_DIR + "/TestServiceImpl.class");
            ...
            try {
                // 将二进制流写到本地磁盘上
                FileOutputStream fos = new FileOutputStream(CLASS_PATH_DIR + "/TestServiceImpl2.class");
                fos.write(code);
                fos.close();
            } catch (IOException e) {
                e.printStackTrace();
